...
<body>
			...
			<div id="forms">
				<p  style="font-size:160%;">Lend Book<br><br>Enter Your book Id</p>
				<form method="post" action="lendbook1.php">
					<input id="reg" name="bid" type="text" placeholder="Bookid" title="Enter Your Bookid" required><br><br><br><br>
					<input id="reg" name="us" type="text" placeholder="Register No or Employee Id" title="Enter Staff's Username" required><br><br><br><br>
					<input type="submit" name="submit" id="sub" class="btn btn-primary btn-lg" value="Lend"></input>
				</form>
			</div>
