...
<body>
			...
			<div id="forms">
				<p  style="font-size:160%;">For Staff Registration</p>
				<form method="post" action="reg.php">
					<input id="reg" name="na" type="text" placeholder="Name" title="Enter Your Name" required><br><br>
					<input id="nam" name="ma" type="email" placeholder="Email" required><br><br>
					<input id="mai" name="user" type="text" placeholder="Register No or Employee Id" required><br><br>
					<input id="pho" name="ps" type="password" placeholder="Password" required><br><br><br>
